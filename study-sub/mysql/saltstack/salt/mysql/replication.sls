...
mysql-replication_config:
  cmd.run:
    - name: "mysql -e \"CHANGE MASTER TO MASTER_HOST='{{ master_ip }}', MASTER_USER='replica', MASTER_PASSWORD='replica', MASTER_LOG_FILE='mysql-bin.000001', MASTER_LOG_POS=624, GET_MASTER_PUBLIC_KEY=1;\" "
